...
class __TwigTemplate_109fc0575edb3e5434502b66270e0e0b extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_previous_page_message($context, array $blocks = [])
    {
        ...
        // line 5
        yield CoreExtension::callMacro($macros["__internal_parse_2"], "macro_resolve_previous_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 5, $this->source); })())], 5, $context, $this->getSourceContext());
    ...
    public function block_next_page_message($context, array $blocks = [])
    {
        ...
        // line 10
        yield CoreExtension::callMacro($macros["__internal_parse_3"], "macro_resolve_next_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 10, $this->source); })())], 10, $context, $this->getSourceContext());
...
", "@BabDevPagerfanta/foundation6.html.twig", "C:\\Users\\user\\Desktop\\MV-Mohamed Alioui\\MV - Mohamed Alioui\\vendor\\babdev\\pagerfanta-bundle\\templates\\foundation6.html.twig");
    }
}
